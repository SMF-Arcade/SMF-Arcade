...
$txt['arcade_extra_options_flash'] = 'Flash Settings';
...
$txt['arcade_following_games_uninstall'] = 'Following games will be uninstalled.<br />
All data related to games will be permanently removed and only way to get it back is to restore from backup.<br />
Press "Uninstall Games" to confirm and complete process.';
